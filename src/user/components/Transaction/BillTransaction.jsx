...
export default function BillTransaction() {
    return (
        <div className="p-8">
            <div className="pb-3">
                <Typography variant="h6" sx={{color: "#DC2A54", fontWeight: "bold", textAlign: "center"}}>BILL DETAILS</Typography>
            </div>
            ...
            <div className="flex flex-col gap-5">
                <div className="">
                    <Typography variant="body2" sx={{color: "#DC2A54", fontWeight: "bold"}}>LOAN DETAILS DETAILS</Typography>
                </div>
